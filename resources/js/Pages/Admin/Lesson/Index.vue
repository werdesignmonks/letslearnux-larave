                        ...
                        <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
                            <div class="overflow-hidden rounded-lg border border-[#E5E6E7]">
                                <table class="min-w-full text-sm font-light overflow-hidden">
                                    ...
                                    <tbody>
                                        <tr class="border-dm-border-color border-t" v-for="(item, index) in props.lessons.data">
                                            ...
                                            <td class="whitespace-nowrap py-4 text-dm-heading-color text-base font-medium">{{ item.chapter.chapter_name }}</td>
                                            <td class="whitespace-nowrap py-4 text-left px-4">
                                                <Link :href="route('lesson.edit', item.id)" class="mr-2 inline-block">
