...
<template>
    <div>
        <div>
            <nav class="border-b-[1px] py-2 border-dm-border-color">
...
<!--                            </div>-->
                            ...
                            <div class="hidden sm:flex sm:items-center">
                                ...
                                <div class="relative">
                                    <Dropdown align="right" width="48">
                                        ...
                                        <template #content>
                                            <DropdownLink :href="route('profile.profile')" :active="route().current('profile.profile')"> Account </DropdownLink>
                                            <DropdownLink :href="route('my-contribution')" :active="route().current('profile.profile')"> My Contributions </DropdownLink>
            ...
            <!-- Page Content -->
            <main class="min-h-[50vh] py-[100px]">
                <slot />
            </main>
